...
const About = () => {
  ...
  return (
    <section id='about' className='max-w-3xl mx-auto pt-16 rounded-lg'>
      ...
      <div className='bg-gray-800/50 rounded-2xl p-6 my-4 mx-2'>
       <p className='text-gray-300 leading-relaxed'>
        Titulaire d'une licence en informatique de gestion, la résolution de problèmes me passionne, et je suis toujours motivé pour apprendre de nouvelles choses. En dehors des heures de code, j'adore suivre des séries ou passer du temps avec mes amis.
